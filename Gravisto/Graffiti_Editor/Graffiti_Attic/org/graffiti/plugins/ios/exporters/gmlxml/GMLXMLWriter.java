...
//
// =============================================================================
// $Id: GMLXMLWriter.java 5772 2010-05-07 18:47:22Z gleissner $
...
public class GMLXMLWriter implements OutputSerializer {
     ...
     * attributes to GML (hierarchical) attributes.
     */
    ...
    public GMLXMLWriter() {
        ...
        dontWriteAttrs = new ArrayList<String>(8);
                ...
                if ("graphics".equals(c.getId())) {
                    ...
                    try {
                        ...
                        if (!bends.isEmpty()) {
                            ...
                            for (Iterator<Attribute> iter = bends
                                    .getCollection().values().iterator(); iter
                                    .hasNext();) {
                                try {
