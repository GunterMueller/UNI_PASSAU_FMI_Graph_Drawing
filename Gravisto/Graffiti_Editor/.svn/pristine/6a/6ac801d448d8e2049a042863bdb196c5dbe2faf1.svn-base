...
import quoggles.auxiliary.FlushRightRenderer;
 ...
 */
public class ConvertToParam_Rep extends DefaultBoxRepresentation 
     ...
     */
    public ConvertToParam_Rep(IBox representedBox) {
    ...
    public void updateGraphicalRep() {
        ...
        combo.setSize(size);
        combo.setRenderer(new FlushRightRenderer());
