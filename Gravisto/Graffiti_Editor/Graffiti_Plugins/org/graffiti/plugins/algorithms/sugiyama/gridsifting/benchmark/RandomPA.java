...
public class RandomPA {
    ...
    private void produceGraph(int nodeCount, int edgeCount, int index) throws IOException {
        String fileName = String.format("%s/randomPA_n%03d_e%04d_i%01d.gml", directory.getCanonicalPath(), nodeCount, edgeCount, index);
