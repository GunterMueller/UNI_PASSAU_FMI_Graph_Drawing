...
//
// =============================================================================
// $Id: SingularValueDecomposition.java 5766 2010-05-07 18:39:06Z gleissner $
 ...
 * orthogonal matrix V so that A = USV'.
 * </p>
 * 
 * <P>
...
public class SingularValueDecomposition implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -982829112717262798L;
    ...
    public SingularValueDecomposition(Matrix Arg) {
        ...
        while (p > 0) {
            ...
            for (k = p - 2; k >= -1; k--) {
                ...
                if (Math.abs(e[k]) <= (eps * (Math.abs(s[k]) + Math
                        .abs(s[k + 1])))) {
                    e[k] = 0.0;
