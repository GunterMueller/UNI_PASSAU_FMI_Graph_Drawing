// =============================================================================
//
//   KKSpringRestrictedAlgorithm.java
//
//   Copyright (c) 2001-2006 Gravisto Team, University of Passau
//
// =============================================================================
// $Id: KKSpringRestrictedAlgorithm.java 5766 2010-05-07 18:39:06Z gleissner $
 ...
 */
public class KKSpringRestrictedAlgorithm extends AbstractAlgorithm {
    ...
    /** DOCUMENT ME! */
    private Selection fixedNodesSel;
    ...
    public String getName() {
        return "KK-Spring-Embedder (restricted)";
    }
    ...
    public Parameter<?>[] getAlgorithmParameters() {
        SelectionParameter fixedNodesParam = new SelectionParameter(
                "Fixed Nodes", "Nodes that are not moved.");
        fixedNodesParam.setSelection(new Selection("_temp2_"));
        ...
        return new Parameter[] { fixedNodesParam, doubleParam, doubleParam2 };
    }
    ...
    public void execute() {
        ...
        List<Node> fixedNodes = fixedNodesSel.getNodes();
        ...
        if (nrNodes > MAX_NODES) {
            ...
            for (Iterator<Node> it = fixedNodes.iterator(); it.hasNext();) {
                selection.remove(it.next());
            }
        ...
        for (Iterator<Node> it = nodes.iterator(); it.hasNext();) {
            ...
            for (Iterator<Map.Entry<Node, PQEntry>> dit = dNodesSet.iterator(); dit
                ...
                if (!node.equals(targetNode)) {
                    ...
                    vlMap2.put(node, new Double((entry.getValue())
                            .getDistance()));
                }
            }
        }
        ...
        ignoreNodes = new LinkedList<Node>(fixedNodes);
