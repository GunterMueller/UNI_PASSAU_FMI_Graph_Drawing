...
public class TestAttribute extends AbstractAttribute {
    ...
    /**
     * Optional. Sets the value of this object. The <code>ListenerManager</code>
     * is automatically informed by the method <code>setValue()</code>.
     * 
     * @param value
     *            the new string value of this object.
     */
