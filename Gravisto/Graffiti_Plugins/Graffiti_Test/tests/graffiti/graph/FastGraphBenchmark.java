...
//
// =============================================================================
// $Id: FastGraphBenchmark.java 5771 2010-05-07 18:46:57Z gleissner $
 ...
 * "-Xmx100M" option.
 */
public class FastGraphBenchmark extends TestCase {
    /** The logger for the current class. */
    private static final Logger logger = Logger
            .getLogger(FastGraphBenchmark.class.getName());
     ...
     */
    public FastGraphBenchmark(String name) {
        super(name);
    }
    ...
    public static void main(String[] args) {
        ...
        junit.textui.TestRunner.run(FastGraphBenchmark.class);
    }
