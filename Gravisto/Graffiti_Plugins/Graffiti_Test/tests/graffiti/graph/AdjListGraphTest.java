// =============================================================================
//
//   AdjListGraphTest.java
//
//   Copyright (c) 2001-2006 Gravisto Team, University of Passau
//
// =============================================================================
// $Id: AdjListGraphTest.java 5771 2010-05-07 18:46:57Z gleissner $
...
public class AdjListGraphTest extends TestCase {
     ...
     */
    public AdjListGraphTest(String name) {
        super(name);
    }
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(AdjListGraphTest.class);
    }
    ...
    public void testAddEdge() {
        ...
        Graph otherGraph = new AdjListGraph();
    ...
    public void testAreConnected() {
        ...
        assertTrue("n1 and n2 are not recognized as being connected.",
                ((AdjListGraph) g).areConnected(n1, n2));
        assertTrue("n1 and n2 are not recognized as being connected.",
                ((AdjListGraph) g).areConnected(n2, n1));
    }
