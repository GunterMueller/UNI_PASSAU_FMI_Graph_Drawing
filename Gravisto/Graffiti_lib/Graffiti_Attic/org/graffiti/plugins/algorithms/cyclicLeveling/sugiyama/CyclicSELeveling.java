...
public class CyclicSELeveling extends AbstractCyclicLeveling {
     ...
     * contains the nodes
     */
    private class Queue extends LinkedList<Node> {
        /**
         * 
         */
        private static final long serialVersionUID = -1071660748268433760L;
        ...
        public Node removeMax() {
            ...
            while (iterator.hasNext()) {
                ...
                if (Math.abs(node.getDouble("force")) >= max) {

                    maxNode = node;
                    max = Math.abs(node.getDouble("force"));
                }
            }
