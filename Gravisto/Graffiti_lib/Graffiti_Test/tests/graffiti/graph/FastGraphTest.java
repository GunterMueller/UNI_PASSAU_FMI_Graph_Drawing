...
//
// =============================================================================
// $Id: FastGraphTest.java 5771 2010-05-07 18:46:57Z gleissner $
...
public class FastGraphTest extends TestCase {
    ...
    /**
     * Constructs a new test case for the <code>FastGraph</code> class.
     * 
     * @param name
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(FastGraphTest.class);
    }
    ...
    public void testAddEdge() {
        ...
        Graph otherGraph = new FastGraph();
    ...
    public void testAddEdgeCopy() {
        Graph g1 = new FastGraph();

        // Node n1 = new AdjListNode(g1);
        Node n1 = g1.addNode();

        // Node n2 = new AdjListNode(g1);
        Node n2 = g1.addNode();

        // Edge e = new AdjListEdge(g1, n1, n2, Edge.DIRECTED);
    ...
    public void testAddGraph() {
        ...
        // nodeList.add(n1);
        // nodeList.add(n2);
        // for (Iterator nodeItr = g.getNodesIterator(); nodeItr.hasNext(); ) {
        ...
        // }
        // }
        // assertTrue("all nodes found in g.", nodeList.isEmpty());
    }
    ...
    public void testAreConnected() {
        ...
        assertTrue("n1 and n2 are not recognized as being connected.",
                ((FastGraph) g).areConnected(n1, n2));
        assertTrue("n1 and n2 are not recognized as being connected.",
                ((FastGraph) g).areConnected(n2, n1));
    }
    ...
    public void testContainsEdge() {
        ...
        g.deleteEdge(e2);
        assertTrue("contains edge e2.", !g.containsEdge(e2));
    ...
    public void testDeleteEdge() {
        ...
        assertTrue("g conatains added edge.", g.containsEdge(e));
        g.deleteEdge(e);
        assertTrue("contains still deleted edge.", !g.containsEdge(e));
        assertTrue("number of edges has correctly been modified.", g
                .getNumberOfEdges() == (noEdges - 1));
        assertTrue("number of directed edges has correctly been modified.", g
    ...
    public void testGetNodes() {
        ...
        Node n3 = g.addNode();
        Node n4 = g.addNode();
        Collection<Node> coll = new ArrayList<Node>(g.getNodes());
    ...
    public void testIsDirected() {
        ...
        g.addEdge(n1, n2, Edge.DIRECTED);
        g.addEdge(n3, n4, Edge.DIRECTED);
        Edge e3 = g.addEdge(n2, n3, Edge.UNDIRECTED);
        assertTrue("graph with undirected edge is directed.", !g.isDirected());
        g.deleteEdge(e3);
        assertTrue("graph is directed again.", g.isDirected());
        g.clear();
        assertTrue("empty graph is directed.", g.isDirected());
    }
    ...
    public void testIsUndirected() {
        ...
        Edge e3 = g.addEdge(n2, n3, Edge.DIRECTED);
        assertTrue("graph with directed edge is undirected.", !g.isUndirected());
        g.deleteEdge(e3);
        assertTrue("graph is undirected again.", g.isUndirected());
        g.clear();
        assertTrue("empty graph is undirected.", g.isUndirected());
    }
