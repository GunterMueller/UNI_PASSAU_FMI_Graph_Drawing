...
//
// =============================================================================
// $Id: LabelNodesByDegreeAction.java 5766 2010-05-07 18:39:06Z gleissner $
...
/**
 * Sets the labels of all selected nodes to their degree. Or sets the labels of
 * all nodes to their degree, if no node is selected.
 * 
 * @author Marek Piorkowski
 * @version $Revision: 5766 $ $Date: 2006-05-08 18:17:37 +0200 (Mon, 08 May
 *          2006) $
 */
public class LabelNodesByDegreeAction extends SelectionAction {
    /**
     * 
     */
    private static final long serialVersionUID = -1098937995998259644L;

    /**
     * Creates a new action.
     * 
     */
    public LabelNodesByDegreeAction() {
        super(GraphEditingBundle.getString("menu.labelNodesByDegreeAction"),
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (selection.getNodes().isEmpty()) {
            EditorGraphEditing.labelNodesByDegree(graph.getNodes());
        } else {
            EditorGraphEditing.labelNodesByDegree(selection.getNodes());
        }
    }
