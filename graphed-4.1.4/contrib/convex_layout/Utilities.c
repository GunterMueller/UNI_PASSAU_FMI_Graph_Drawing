...
Snode  GetTargetNode(Slist TheEdgelistElem)
...
Snode  GetSourceNode(Slist TheEdgelistElem)
...
Snode  TargetNodeGet(Slist TheEdgelistElem)
...
Snode  SourceNodeGet(Slist TheEdgelistElem)
...
void AppendEdgeStack(EdgeStack *TheStack, Slist NewEdge)
...
void AppendSedgeStack(SedgeStack *TheStack, Sedge NewEdge)
...
Snode FindNode(Sgraph TheGraph, AttrType IdentAttr, int IdentNr)
...
Snode FindNodeWithMinXKoor(Sgraph TheGraph)
...
Slist FindFacialCycle(Sgraph TheGraph)
...
void DrawNodeBetweenAB(Snode TheNode, Point A, Point B, double lambda)
