...
int NumberOfEdges(Sgraph TheGraph)
...
int NumberOfNodes(Sgraph TheGraph)
...
bool contains_element(Slist TheEdgeList, Sedge ActEdge)
  /*
...
int NoEdgeOnNode(Sgraph TheGraph)
...
bool NoMultipleEdges(Sgraph TheGraph)
  /*
...
bool DrawConvexPossible(Sgraph TheGraph)
    /*
 ...
 
   {
     ...
     if (TheGraph == empty_graph || TheGraph->nodes == EmptySnode)
            {
