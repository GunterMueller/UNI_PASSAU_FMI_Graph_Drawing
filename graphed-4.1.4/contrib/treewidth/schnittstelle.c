...
void dummy (Tree_width_info info)
{message("hier kann eine eigene Berechnugsroutine installiert werden.");}

/***************************************************************************/
void dummy2 (Tree_width_info info)
{message("Dummy 2. info->sgraph->node->label=%s",info->sgraph_proc_info->sgraph->nodes->label);}

/***************************************************************************/
/***************************************************************************/
void init_treewidth_menu(void)
{/*add_to_treewidth_menu("Meine_ERWEITERUNG1",dummy);
      add_to_treewidth_menu("Meine_ERWEITERUNG2",dummy2);*/}
