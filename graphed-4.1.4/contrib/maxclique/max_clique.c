...
static Slist Nodelist_to_Slist (L_node_list list)
...
static L_node_list Slist_to_Nodelist (Slist list)
...
static void main_proc_maxclique(Sgraph_proc_info info)
...
void	menu_max_clique (Menu menu, Menu_item menu_item)
{
	call_sgraph_proc (main_proc_maxclique, NULL);
}
