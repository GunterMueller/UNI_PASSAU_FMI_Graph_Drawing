...
static bool has_edge_to_every_undeterm(Snode node)
...
static void copy_determ_nodes(void)
	/*
...
static bool has_edge_to_none_undeterm(Snode node)
...
static void suspend_0_edge_nodes(void)
	/*
...
static void unvollst_clique(void)
	/*
...
L_node_list K_knoten_clique(Snode node, int mincliq, int maxcliq, L_node_list nodebase)
...
L_node_list K_knoten_list_clique(L_node_list list)
