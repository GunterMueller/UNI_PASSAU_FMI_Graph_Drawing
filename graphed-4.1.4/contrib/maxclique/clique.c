...
static int max_cliquen_kanten(L_node_list l)
...
static L_node_list  make_search_list(int maxkanten, L_node_list l)
...
static L_node_list search_clique(L_node_list inlist)
...
L_node_list C_find_clique_in_list(L_node_list list)
...
L_node_list C_find_clique (Sgraph g)
