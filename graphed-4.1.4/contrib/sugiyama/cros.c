...
/* static int check(int i, int limit) { if(i<0 && i>=limit) printf("i : %d, limit : %d\n", i, limit); return 1;  } */
...
Local bool sorted(double *vector, int max)
...
Local bool equal_m(Matrix m1, Matrix m2, int r, int c)
...
Local bool equal_a(Matrix a1, Matrix a2)					/* !!! */
