...
extern bool is_dummy(Snode node);

Local Node_data *nl;



Local int upper_connectivity(Snode node)
{	
	int result;
	Sedge edge;
...
Local int lower_connectivity(Snode node)
{
	int result;
	Sedge edge;
...
Local int upper_barycenter(Snode node)
{
	int result = 0;
	Sedge edge;
...
Local int lower_barycenter(Snode node)
{
	int result = 0;
	Sedge edge;
...
Local 	void	make_node_list_up(Sgraph g, int l)
{
	Snode n;
	int i = 0;
...
Local 	void	make_node_list_down(Sgraph g, int l)
{
	Snode n;
	int i = 0;
...
Global	void	improve_positions(Sgraph g)
{
