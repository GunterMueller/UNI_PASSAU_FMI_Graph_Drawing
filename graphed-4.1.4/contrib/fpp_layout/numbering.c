...
static int neighboring_edge_test (struct fpp_node *process, struct nlist *nei);
...
{
	struct fpp_node *process, *cn_list_end;
	struct nlist *nei;
	int i, pro, pcounter;
...
{
	struct nlist *nei, *nei2;
	struct fpp_node *pro_node1, *pro_node2;
