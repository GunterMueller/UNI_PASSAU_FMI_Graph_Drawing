...
extern	void	MY_CMD_position_relative(Frame win, Frame reference, int x, int y);
extern	void	MY_WIN_position_relative(Frame win, Frame reference, int x, int y);
extern	void	MY_WIN_position_absolute(Frame win, int x, int y);
extern	void	MY_cycle_panel_choice_stack(Panel_item item, int value, Event *event);
