...
/************************************************************************/
/*****************************************************************************
function	create_oriented_multi_lgg_layout

	create the graph for a multi lgg
*****************************************************************************/

void	create_oriented_multi_lgg_layout(Graph graph)
{
	...
	pass_2a_multi_oriented		( graph->lp_graph.derivation_net 	); 
	pass_2b_multi_oriented		( graph->lp_graph.derivation_net 	); 
...
/************************************************************************
function:	create_oriented_multi_lgg

	Find the selected graph and create a multi lgg of it
************************************************************************/

void	create_oriented_multi_lgg(void)
{
