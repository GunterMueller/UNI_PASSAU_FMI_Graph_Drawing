...
void cwr (Bin_Tree t, int *pminx, int *pmaxx)
...
void calc_width_rel (Bin_Tree t, int *pw)
...
Bin_Tree next_bad_left (Bin_Tree t)
...
Bin_Tree next_bad_right (Bin_Tree t)
...
void correct_tree (Bin_Tree t, int level, Extreme *rmost, Extreme *lmost)
...
void correct_if_necessary (Bin_Tree t, int level, Extreme *rmost, Extreme *lmost)
