...
void petrify (Bin_Tree t, int xpos)
...
Global void setup (Bin_Tree t, int level, Extreme *rmost, Extreme *lmost, int call_correction)
...
Global void modified_rt_algorithm (Bin_Tree t)
