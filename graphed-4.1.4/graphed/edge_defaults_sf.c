...
static	void		hide_edge_defaults_subframe           (Frame frame);
/* static	void		notify_edge_defaults_subframe_buttons (Panel_item item, Event *event); */
static	void		notify_edge_defaults_subframe_cycles  (Panel_item item, int value, Event *event);
...
void	create_edge_defaults_subframe (void)
{
	int		row_count = 0;
	...
	edge_defaults_subframe_label_visibility_cycle = xv_create(edge_defaults_subframe_panel, PANEL_CHECK_BOX,
...
void	show_edge_defaults_subframe (Edge_defaults_subframe_info *caller_info, void (*caller_completion_proc) ())
{
	int		x, y;
...
void	install_fontlist_in_edge_defaults_subframe (char **list)
{
...
void	install_edgetypelist_in_edge_defaults_subframe (char **list)
{
...
static	void	notify_edge_defaults_subframe_buttons (Panel_item item, Event *event)
{
	if (item == edge_defaults_subframe) {
		hide_edge_defaults_subframe ((Frame)0);
	}
}
*/
