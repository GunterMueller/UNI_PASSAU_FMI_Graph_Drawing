...
static	void		hide_group_subframe           (Frame frame);
static	void		notify_group_subframe_buttons (Panel_item item, Event *event);
static	void		notify_group_subframe_cycles  (Panel_item item, int value, Event *event);
static	void		notify_group_subframe_toggles (Panel_item item, int value, Event *event);
...
void	create_group_subframe (void)
{
	int	row_count = 0;
...
#	define COL_42 78
	...
	group_subframe_nodelabel_visibility_cycle = xv_create(group_subframe_panel, PANEL_CHECK_BOX,
	...
	group_subframe_scale_cycle = xv_create(group_subframe_panel, PANEL_CHOICE,
	...
	group_subframe_set_nei_cycle = xv_create(group_subframe_panel, PANEL_CHOICE,
	...
	group_subframe_set_nlp_cycle = xv_create(group_subframe_panel, PANEL_CHOICE,
...
*/
	...
	group_subframe_edgelabel_visibility_cycle = xv_create(group_subframe_panel, PANEL_CHECK_BOX,
...
void	show_group_subframe (Group group)
{
	int		x, y;
	Rect		group_rect;
	...
	if (showing_group_subframe) hide_group_subframe ((Frame)0);
...
Group	get_currently_edited_group (void)
{
...
void	install_fontlist_in_group_subframe (char **list)
{
...
void	install_nodetypelist_in_group_subframe (char **list)
{
	xv_set(group_subframe_nodetype_selection, ATTR_LIST, list, NULL);
}


void	install_edgetypelist_in_group_subframe (char **list)
{
