...
static	void	hide_node_defaults_subframe           (Frame frame);
/* static	void	notify_node_defaults_subframe_buttons (Panel_item item, Event *event); */
static	void	notify_node_defaults_subframe_cycles  (Panel_item item, int value, Event *event);
...
void	create_node_defaults_subframe (void)
{
	int	row_count = 0;
	...
	node_defaults_subframe_label_visibility_cycle = xv_create(node_defaults_subframe_panel, PANEL_CHECK_BOX,
	...
	node_defaults_subframe_scale_cycle = xv_create(node_defaults_subframe_panel, PANEL_CHOICE,
	...
	row_count ++;
	node_defaults_subframe_set_nei_cycle = xv_create(node_defaults_subframe_panel, PANEL_CHOICE,
	...
	node_defaults_subframe_set_nlp_cycle = xv_create(node_defaults_subframe_panel, PANEL_CHOICE,
...
void				show_node_defaults_subframe (Node_defaults_subframe_info *caller_info, void (*caller_completion_proc) ())
{
	int	x, y;
	int	node_defaults_subframe_height, node_defaults_subframe_width;

	if (showing_node_defaults_subframe) hide_node_defaults_subframe ((Frame)0);
...
void	install_fontlist_in_node_defaults_subframe (char **list)
{
...
void	install_nodetypelist_in_node_defaults_subframe (char **list)
{
