...
Node_template	create_node_template (Node node)
{
...
Edge_template	create_edge_template (Edge edge)
{
...
Node		create_node_from_template (Node_template template)
{
	int	i, found = FALSE;
	Graph	g, graph;
	Node	node;
...
Edge		create_edge_from_template (Edge_template template)
{
	int	i, found        = FALSE,
		   found_graph  = FALSE;
	Graph	g, graph;
