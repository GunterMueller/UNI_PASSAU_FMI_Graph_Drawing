...
static	void	hide_gragra_subframe           (Frame frame);
static	void	notify_gragra_subframe_buttons (Panel_item item, Event *event);
static	void	notify_gragra_subframe_cycles  (Panel_item item, int value, Event *event);
static	void	set_left_side_style            (Node_defaults_subframe_info *info);
static	void	set_embed_node_style           (Node_defaults_subframe_info *info);
static	void	set_embed_edge_style           (Edge_defaults_subframe_info *info);
...
void	create_gragra_subframe (void)
{
	int	row_count = 0;
	Icon 	icon;

	gragra_subframe = (Frame)xv_create(base_frame, FRAME_CMD,
		FRAME_LABEL,		"graph grammar settings",
	...
	gragra_subframe_panel = (Panel)xv_get(gragra_subframe,
		FRAME_CMD_PANEL);

	gragra_subframe_type_cycle = xv_create(
		gragra_subframe_panel,	PANEL_CHOICE,
	...
	row_count ++;
	gragra_subframe_always_match_empty_cycle = xv_create(
		gragra_subframe_panel,  PANEL_CHECK_BOX,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
		PANEL_LABEL_STRING,	"empty labels in productions are wildcards",
/*		PANEL_CHOICE_STRINGS,	boolean_ordered_list("wildcards",TRUE, "empty labels",FALSE), 0, */
	...
	row_count ++;
	gragra_subframe_nodetypes_significant = xv_create(
		gragra_subframe_panel,	PANEL_CHECK_BOX,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
		PANEL_LABEL_STRING,	"nodetypes are significant",
/*		PANEL_CHOICE_STRINGS,	boolean_ordered_list("significant",TRUE, "not significant",FALSE), 0, */
	...
	row_count ++;
	gragra_subframe_nodecolors_significant = xv_create(
		gragra_subframe_panel,	PANEL_CHECK_BOX,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
		PANEL_LABEL_STRING,	"nodecolors are significant",
/*		PANEL_CHOICE_STRINGS,	boolean_ordered_list("significant",TRUE, "not significant",FALSE), 0, */
		PANEL_LABEL_BOLD,	TRUE,
		PANEL_CHOICES_BOLD,	TRUE,
		NULL);
	...
	row_count ++;
	gragra_subframe_edgetypes_significant = xv_create(
		gragra_subframe_panel,	PANEL_CHECK_BOX,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
		PANEL_LABEL_STRING,	"edgetypes are significant",
/*		PANEL_CHOICE_STRINGS,	boolean_ordered_list("significant",TRUE, "not significant",FALSE), 0, */
		PANEL_LABEL_BOLD,	TRUE,
		PANEL_CHOICES_BOLD,	TRUE,
		NULL);
	...
	row_count ++;
	gragra_subframe_edgecolors_significant = xv_create(
		gragra_subframe_panel,	PANEL_CHECK_BOX,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
		PANEL_LABEL_STRING,	"edgecolors are significant",
/*		PANEL_CHOICE_STRINGS,	boolean_ordered_list("significant",TRUE, "not significant",FALSE), 0, */
		PANEL_LABEL_BOLD,	TRUE,
		PANEL_CHOICES_BOLD,	TRUE,
		NULL);
	...
	row_count ++;
	gragra_subframe_terminals_text = xv_create(
		gragra_subframe_panel,	PANEL_TEXT,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
	...
	row_count ++;
	gragra_subframe_nonterminals_text = xv_create(
		gragra_subframe_panel,	PANEL_TEXT,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
	...
	row_count ++;
	gragra_subframe_left_side_style_button = xv_create(
		gragra_subframe_panel,	PANEL_BUTTON,
		XV_X,			xv_col(gragra_subframe_panel, 0),
		XV_Y,			xv_row(gragra_subframe_panel, row_count),
	...
	gragra_subframe_embed_node_style_button = xv_create(
		gragra_subframe_panel,	PANEL_BUTTON,
	...
	gragra_subframe_embed_edge_style_button = xv_create(
		gragra_subframe_panel,	PANEL_BUTTON,
...
void	show_gragra_subframe (void)
{
	create_gragra_subframe ();
	
	lock_user_interface ();
	
	xv_set(gragra_subframe_type_cycle,
		PANEL_VALUE, gragra_type_to_int(current_gragra_type),
		NULL);
	xv_set(gragra_subframe_always_match_empty_cycle,
		PANEL_VALUE, get_gragra_always_match_empty (),
		NULL);
	xv_set(gragra_subframe_terminals_text,
		PANEL_VALUE, current_gragra_terminals,
		NULL);
	xv_set(gragra_subframe_nonterminals_text,
		PANEL_VALUE, current_gragra_nonterminals,
		NULL);
	xv_set(gragra_subframe_nodetypes_significant,
		PANEL_VALUE, iif (get_embed_match_attributes() & NODE_TYPE, TRUE, FALSE),
		NULL);
	xv_set(gragra_subframe_edgetypes_significant,
		PANEL_VALUE, iif (get_embed_match_attributes() & EDGE_TYPE, TRUE, FALSE),
		NULL);
	xv_set(gragra_subframe_nodecolors_significant,
		PANEL_VALUE, iif (get_embed_match_attributes() & NODE_COLOR, TRUE, FALSE),
		NULL);
	xv_set(gragra_subframe_edgecolors_significant,
		PANEL_VALUE, iif (get_embed_match_attributes() & EDGE_COLOR, TRUE, FALSE),
		NULL);
