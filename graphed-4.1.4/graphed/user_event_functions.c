...
static	User_event_functions_result	user_event_null_proc (UEV_info info, Event *event)
{
	return UEV_CONSUMED;
}


void				set_user_event_func (User_event_functions_type type, User_event_functions_result (*func) (/* ??? */))
{
  user_event_functions.func[type] = func;
}


void				remove_user_event_func (User_event_functions_type type, User_event_functions_result (*func) (/* ??? */))
{
  user_event_functions.func[type] = user_event_null_proc;
}


User_event_functions_result	call_user_event_func (User_event_functions_type type, User_event_functions_state state, Event *event, char *args)
{
	...
	switch (type) {
	    case UEV_CLICK :
		info.do_default_action = ((Click_info*)args)->do_default_action;
		break;
	    case UEV_DOUBLE_CLICK :
		info.do_default_action = ((Double_click_info*)args)->do_default_action;
		break;
	    case UEV_DRAG_NODE :
	...
	switch (type) {
	    case UEV_CLICK :
		((Click_info*)args)->do_default_action = info.do_default_action;
		break;
	    case UEV_DOUBLE_CLICK :
		((Double_click_info*)args)->do_default_action = info.do_default_action;
		break;
	    case UEV_DRAG_NODE :
...
/*
static	void		sgraph_event_null_proc (Sgraph_proc_info info, Sgraph_event_proc_info uev_info, Event *event)
{
	info->save_selection = TRUE;
}
*/

User_event_functions_result	default_uev_click_func (UEV_info info, Event *event)
{
/*	message ("A click\n"); */
	return UEV_CONSUMED;
}
...
User_event_functions_result	default_uev_double_click_func (UEV_info info, Event *event)
{
...
User_event_functions_result	default_uev_drag_node_func (UEV_info info, Event *event)
{
/*
...
User_event_functions_result	default_uev_drag_edge_func (UEV_info info, Event *event)
{
...
User_event_functions_result	default_uev_drag_group_func (UEV_info info, Event *event)
{
	static	int	last_x, last_y;
...
User_event_functions_result	default_uev_drag_box_func (UEV_info info, Event *event)
{
	return UEV_CONSUMED;
}

void	init_user_event_functions (void)
{
