...
#define MAX_SYSTEM_NODETYPE  MAX_NODETYPE
#define MAX_SYSTEM_EDGETYPE  MAX_NODETYPE
...
#define DOTSIZE 1		/* Pixel size of a grid point		*/
#define	MARKER_SQUARE_SIZE 4	/* Pixel size of node/edge/group marker	*/
...
#define GRAPHED2
#define	GRAPHED_VERSION graphed_version
extern	char	*graphed_version;
