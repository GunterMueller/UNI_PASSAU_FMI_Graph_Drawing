...
static	void	do_move_group                   (Group group, int dx, int dy, int only_set);
...
Group	add_immediately_to_group (Group group, Node node)
{
...
Group	add_to_group (Group group, Node node)
{
	if (node == empty_node)
		return group;
...
Group	subtract_immediately_from_group (Group group, Group g)
{
	if (g == empty_group) {
		; /* nothing to do ... */
...
Group	subtract_from_group (Group group, Node node)
{
	Group	g;
...
Group	add_groups (Group g1, Group g2)
{
	Group	g;
...
Group	add_groups_disjoint (Group g1, Group g2)
{
	Group	g;
...
Group	subtract_groups (Group g1, Group g2)
{
	Group	g;
...
int	group_contains_exactly_one_node	(Group group)
{
	if (group != empty_group)
...
Group	contains_group_node (Group group, Node node)
{
	Group	g;
...
int	contains_group_graph (Group group, Graph graph)
{
	Node	node;
...
int	intersects_group_graph (Group group, Graph graph)
{
	Group	g;
...
int	group_intersects_group (Group group1, Group group2)
{
	Group	g1,g2;
...
Rect	compute_rect_around_group (Group group)
{
	Group	g;
	Edge	edge;
	Rect	rect;
...
Group	make_group_of_graph (Graph graph)
{
	Node	node;
	Group	group_to_make;
...
Group	make_group_of_sourcelist (Node node)
{
	Edge	edge;
	Group	group_to_make;
...
Group	make_group_of_targetlist (Node node)
{
	Edge	edge;
	Group	group_to_make;
...
Graph	make_graph_of_group (int buffer, Group group)
{
	Graph	new_graph;
	Edge	edge;
	Group	g;
...
Group	copy_group_to_graph (Group group, Graph graph)
{
	Node	node;
	Edge	edge;
...
int	group_nodes_are_all_of_same_graph (Group group)
{
	Group	g;
